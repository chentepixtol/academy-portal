  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in ProyectoPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			ProyectoPeer::clearInstancePool();

			// invalidate objects in SitioPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			SitioPeer::clearInstancePool();

			// invalidate objects in VideoPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(MateriaProfesorPeer::PROFESOR_ID, $obj->getId());
			$affectedRows += MateriaProfesorPeer::doDelete($c, $con);

			// delete related Proyecto objects
			$c = new Criteria(ProyectoPeer::DATABASE_NAME);
			
			$c->add(ProyectoPeer::PROFESOR_ID, $obj->getId());
			$affectedRows += ProyectoPeer::doDelete($c, $con);

			// delete related Sitio objects
			$c = new Criteria(SitioPeer::DATABASE_NAME);
			
			$c->add(SitioPeer::PROFESOR_ID, $obj->getId());
			$affectedRows += SitioPeer::doDelete($c, $con);

			// delete related Video objects
			$c = new Criteria(VideoPeer::DATABASE_NAME);
			
			$c->add(VideoPeer::PROFESOR_ID, $obj->getId());
			$affectedRows += VideoPeer::doDelete($c, $con);

			// delete related Wiki objects
			$c = new Criteria(WikiPeer::DATABASE_NAME);
			
			$c->add(WikiPeer::PROFESOR_ID, $obj->getId());
			$affectedRows += WikiPeer::doDelete($c, $con);

			// delete related Evaluacion objects
			$c = new Criteria(EvaluacionPeer::DATABASE_NAME);
			
			$c->add(EvaluacionPeer::PROFESOR_ID, $obj->getId());

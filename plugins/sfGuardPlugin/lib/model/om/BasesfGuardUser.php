...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserPeer';
	...
	/**
	 * @var        array MateriaProfesor[] Collection to store aggregation of MateriaProfesor objects.
	 */
	protected $collMateriaProfesors;

	/**
	 * @var        Criteria The criteria used to select the current contents of collMateriaProfesors.
	 */
	private $lastMateriaProfesorCriteria = null;
	...
	/**
	 * @var        array Sitio[] Collection to store aggregation of Sitio objects.
	 */
	protected $collSitios;

	/**
	 * @var        Criteria The criteria used to select the current contents of collSitios.
	 */
	private $lastSitioCriteria = null;
	...
	/**
	 * @var        array Wiki[] Collection to store aggregation of Wiki objects.
	 */
	protected $collWikis;

	/**
	 * @var        Criteria The criteria used to select the current contents of collWikis.
	 */
	private $lastWikiCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collMateriaProfesors = null;
			$this->lastMateriaProfesorCriteria = null;

			$this->collProyectos = null;
			$this->lastProyectoCriteria = null;

			$this->collSitios = null;
			$this->lastSitioCriteria = null;

			$this->collVideos = null;
			$this->lastVideoCriteria = null;

			$this->collWikis = null;
			$this->lastWikiCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collMateriaProfesors !== null) {
				foreach ($this->collMateriaProfesors as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collSitios !== null) {
				foreach ($this->collSitios as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collWikis !== null) {
				foreach ($this->collWikis as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getMateriaProfesors() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addMateriaProfesor($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getSitios() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addSitio($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getWikis() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addWiki($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collMateriaProfesors collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addMateriaProfesors()
	 */
	public function clearMateriaProfesors()
	{
		$this->collMateriaProfesors = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collMateriaProfesors collection (array).
	 *
	 * By default this just sets the collMateriaProfesors collection to an empty array (like clearcollMateriaProfesors());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initMateriaProfesors()
	{
		$this->collMateriaProfesors = array();
	}

	/**
	 * Gets an array of MateriaProfesor objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related MateriaProfesors from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array MateriaProfesor[]
	 * @throws     PropelException
	 */
	public function getMateriaProfesors($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collMateriaProfesors === null) {
			if ($this->isNew()) {
			   $this->collMateriaProfesors = array();
				...
				$criteria->add(MateriaProfesorPeer::PROFESOR_ID, $this->id);

				MateriaProfesorPeer::addSelectColumns($criteria);
				$this->collMateriaProfesors = MateriaProfesorPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				MateriaProfesorPeer::addSelectColumns($criteria);
				if (!isset($this->lastMateriaProfesorCriteria) || !$this->lastMateriaProfesorCriteria->equals($criteria)) {
					$this->collMateriaProfesors = MateriaProfesorPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastMateriaProfesorCriteria = $criteria;
		return $this->collMateriaProfesors;
	}

	/**
	 * Returns the number of related MateriaProfesor objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related MateriaProfesor objects.
	 * @throws     PropelException
	 */
	public function countMateriaProfesors(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collMateriaProfesors === null) {
			if ($this->isNew()) {
				...
				$count = MateriaProfesorPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastMateriaProfesorCriteria) || !$this->lastMateriaProfesorCriteria->equals($criteria)) {
					...
					$count = count($this->collMateriaProfesors);
				}
			} else {
				$count = count($this->collMateriaProfesors);
			}
	...
	/**
	 * Method called to associate a MateriaProfesor object to this object
	 * through the MateriaProfesor foreign key attribute.
	 *
	 * @param      MateriaProfesor $l MateriaProfesor
	 * @return     void
	 * @throws     PropelException
	 */
	public function addMateriaProfesor(MateriaProfesor $l)
	{
		if ($this->collMateriaProfesors === null) {
			$this->initMateriaProfesors();
		}
		if (!in_array($l, $this->collMateriaProfesors, true)) { // only add it if the **same** object is not already associated
			array_push($this->collMateriaProfesors, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * been saved, it will retrieve related MateriaProfesors from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getMateriaProfesorsJoinMateria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collMateriaProfesors === null) {
			if ($this->isNew()) {
				...
				$this->collMateriaProfesors = MateriaProfesorPeer::doSelectJoinMateria($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Proyectos from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProyectos === null) {
			if ($this->isNew()) {
			   $this->collProyectos = array();
				...
				$criteria->add(ProyectoPeer::PROFESOR_ID, $this->id);
	...
	public function countProyectos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collProyectos === null) {
			if ($this->isNew()) {
				...
				$count = ProyectoPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Clears out the collSitios collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addSitios()
	 */
	public function clearSitios()
	{
		$this->collSitios = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collSitios collection (array).
	 *
	 * By default this just sets the collSitios collection to an empty array (like clearcollSitios());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initSitios()
	{
		$this->collSitios = array();
	}

	/**
	 * Gets an array of Sitio objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Sitios from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getSitios($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collSitios === null) {
			if ($this->isNew()) {
			   $this->collSitios = array();
				...
				$criteria->add(SitioPeer::PROFESOR_ID, $this->id);

				SitioPeer::addSelectColumns($criteria);
				$this->collSitios = SitioPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				SitioPeer::addSelectColumns($criteria);
				if (!isset($this->lastSitioCriteria) || !$this->lastSitioCriteria->equals($criteria)) {
					$this->collSitios = SitioPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastSitioCriteria = $criteria;
		return $this->collSitios;
	}

	/**
	 * Returns the number of related Sitio objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Sitio objects.
	 * @throws     PropelException
	 */
	public function countSitios(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collSitios === null) {
			if ($this->isNew()) {
				...
				$count = SitioPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a Sitio object to this object
	 * through the Sitio foreign key attribute.
	 *
	 * @param      Sitio $l Sitio
	 * @return     void
	 * @throws     PropelException
	 */
	public function addSitio(Sitio $l)
	{
		if ($this->collSitios === null) {
			$this->initSitios();
		}
		if (!in_array($l, $this->collSitios, true)) { // only add it if the **same** object is not already associated
			array_push($this->collSitios, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Videos from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
			   $this->collVideos = array();
				...
				$criteria->add(VideoPeer::PROFESOR_ID, $this->id);
	...
	public function countVideos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
				...
				$count = VideoPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Clears out the collWikis collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	{
		$this->collWikis = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWikis collection (array).
	 *
	 * By default this just sets the collWikis collection to an empty array (like clearcollWikis());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initWikis()
	{
		$this->collWikis = array();
	}

	/**
	 * Gets an array of Wiki objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Wikis from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getWikis($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collWikis === null) {
			if ($this->isNew()) {
			   $this->collWikis = array();
				...
				$criteria->add(WikiPeer::PROFESOR_ID, $this->id);

				WikiPeer::addSelectColumns($criteria);
				$this->collWikis = WikiPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				WikiPeer::addSelectColumns($criteria);
				if (!isset($this->lastWikiCriteria) || !$this->lastWikiCriteria->equals($criteria)) {
					$this->collWikis = WikiPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastWikiCriteria = $criteria;
		return $this->collWikis;
	}

	/**
	 * Returns the number of related Wiki objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Wiki objects.
	 * @throws     PropelException
	 */
	public function countWikis(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collWikis === null) {
			if ($this->isNew()) {
				...
				$count = WikiPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a Wiki object to this object
	 * through the Wiki foreign key attribute.
	 *
	 * @param      Wiki $l Wiki
	 * @return     void
	 * @throws     PropelException
	 */
	public function addWiki(Wiki $l)
	{
		if ($this->collWikis === null) {
			$this->initWikis();
		}
		if (!in_array($l, $this->collWikis, true)) { // only add it if the **same** object is not already associated
			array_push($this->collWikis, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related Wikis from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getWikisJoinMateria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collWikis === null) {
			if ($this->isNew()) {
				...
				$this->collWikis = WikiPeer::doSelectJoinMateria($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Evaluacions from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collEvaluacions === null) {
			if ($this->isNew()) {
			   $this->collEvaluacions = array();
				...
				$criteria->add(EvaluacionPeer::PROFESOR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getEvaluacionsJoinPregunta($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collEvaluacions === null) {
			if ($this->isNew()) {
				...
				$this->collEvaluacions = EvaluacionPeer::doSelectJoinPregunta($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collMateriaProfesors) {
				foreach ((array) $this->collMateriaProfesors as $o) {
					$o->clearAllReferences($deep);
				}
			}
			...
			if ($this->collSitios) {
				foreach ((array) $this->collSitios as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collVideos) {
			...
			if ($this->collWikis) {
				foreach ((array) $this->collWikis as $o) {
					$o->clearAllReferences($deep);
				}
			}

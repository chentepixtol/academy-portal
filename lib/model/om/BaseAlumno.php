...
abstract class BaseAlumno extends BaseObject  implements Persistent {
  ...
  const PEER = 'AlumnoPeer';
	...
	/**
	 * Initializes internal state of BaseAlumno object.
	 * @see        applyDefaults()
	 */
	...
	public function setUsername($v)
	{
		...
		if ($this->username !== $v) {
			$this->username = $v;
			$this->modifiedColumns[] = AlumnoPeer::USERNAME;
		}
	...
	public function setPassword($v)
	{
		...
		if ($this->password !== $v) {
			$this->password = $v;
			$this->modifiedColumns[] = AlumnoPeer::PASSWORD;
		}
	...
	public function setApellidoPaterno($v)
	{
		...
		if ($this->apellido_paterno !== $v) {
			...
			$this->modifiedColumns[] = AlumnoPeer::APELLIDO_PATERNO;
		}
	...
	public function setBoleta($v)
	{
		...
		if ($this->boleta !== $v) {
			$this->boleta = $v;
			$this->modifiedColumns[] = AlumnoPeer::BOLETA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->apellido_paterno = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->apellido_materno = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 8; // 8 = AlumnoPeer::NUM_COLUMNS - AlumnoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlumnoPeer::USERNAME)) $criteria->add(AlumnoPeer::USERNAME, $this->username);
		if ($this->isColumnModified(AlumnoPeer::PASSWORD)) $criteria->add(AlumnoPeer::PASSWORD, $this->password);
		...
		if ($this->isColumnModified(AlumnoPeer::APELLIDO_PATERNO)) $criteria->add(AlumnoPeer::APELLIDO_PATERNO, $this->apellido_paterno);
		if ($this->isColumnModified(AlumnoPeer::APELLIDO_MATERNO)) $criteria->add(AlumnoPeer::APELLIDO_MATERNO, $this->apellido_materno);
		if ($this->isColumnModified(AlumnoPeer::BOLETA)) $criteria->add(AlumnoPeer::BOLETA, $this->boleta);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseAlumno:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseAlumno::%s', $method));
    }

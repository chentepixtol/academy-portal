...
abstract class BaseWikiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Wiki';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'MateriaId', 'ProfesorId', 'Titulo', 'Texto', 'Fecha', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'materiaId', 'profesorId', 'titulo', 'texto', 'fecha', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::MATERIA_ID, self::PROFESOR_ID, self::TITULO, self::TEXTO, self::FECHA, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'materia_id', 'profesor_id', 'titulo', 'texto', 'fecha', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MateriaId' => 1, 'ProfesorId' => 2, 'Titulo' => 3, 'Texto' => 4, 'Fecha' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'materiaId' => 1, 'profesorId' => 2, 'titulo' => 3, 'texto' => 4, 'fecha' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MATERIA_ID => 1, self::PROFESOR_ID => 2, self::TITULO => 3, self::TEXTO => 4, self::FECHA => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'materia_id' => 1, 'profesor_id' => 2, 'titulo' => 3, 'texto' => 4, 'fecha' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new WikiMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(WikiPeer::MATERIA_ID);

		$criteria->addSelectColumn(WikiPeer::PROFESOR_ID);

		$criteria->addSelectColumn(WikiPeer::TITULO);

		$criteria->addSelectColumn(WikiPeer::TEXTO);

		$criteria->addSelectColumn(WikiPeer::FECHA);
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $criteria, $con);
    }
	...
	public static function doCountJoinMateria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WikiPeer::MATERIA_ID,), array(MateriaPeer::ID,), $join_behavior);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WikiPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Wiki objects pre-filled with their Materia objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wiki objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $c, $con);
    }
		...
		WikiPeer::addSelectColumns($c);
		$startcol = (WikiPeer::NUM_COLUMNS - WikiPeer::NUM_LAZY_LOAD_COLUMNS);
		MateriaPeer::addSelectColumns($c);

		$c->addJoin(array(WikiPeer::MATERIA_ID,), array(MateriaPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = WikiPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = WikiPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				// $obj1->hydrate($row, 0, true); // rehydrate
			} else {

				$omClass = WikiPeer::getOMClass();

				$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);
				$obj1 = new $cls();
				$obj1->hydrate($row);
				WikiPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wiki) to $obj2 (Materia)
				$obj2->addWiki($obj1);
	...
	/**
	 * Selects a collection of Wiki objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wiki objects.
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(WikiPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wiki) to $obj2 (sfGuardUser)
				$obj2->addWiki($obj1);
	...
	/**
	 * Selects a collection of Wiki objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $c, $con);
    }
		...
		WikiPeer::addSelectColumns($c);
		$startcol2 = (WikiPeer::NUM_COLUMNS - WikiPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wiki) to the collection in $obj2 (Materia)
				$obj2->addWiki($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Wiki) to the collection in $obj3 (sfGuardUser)
				$obj3->addWiki($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Wiki objects pre-filled with all related objects except Materia.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = WikiPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Wiki) to the collection in $obj2 (sfGuardUser)
				$obj2->addWiki($obj1);
	...
	/**
	 * Selects a collection of Wiki objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseWikiPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseWikiPeer', $values, $con);
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(WikiPeer::ID, $criteria->remove(WikiPeer::ID), $comparison);
    ...
    foreach (sfMixer::getCallables('BaseWikiPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseWikiPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(WikiPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	public static function doValidate(Wiki $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(WikiPeer::DATABASE_NAME, WikiPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = WikiPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the WikiPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the WikiPeer class:
//
// Propel::getDatabaseMap(WikiPeer::DATABASE_NAME)->addTableBuilder(WikiPeer::TABLE_NAME, WikiPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseWikiPeer::DATABASE_NAME)->addTableBuilder(BaseWikiPeer::TABLE_NAME, BaseWikiPeer::getMapBuilder());

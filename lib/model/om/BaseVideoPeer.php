...
abstract class BaseVideoPeer {
	...
	const PROFESOR_ID = 'video.PROFESOR_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ProfesorId', 'Titulo', 'Url', 'Fecha', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'profesorId', 'titulo', 'url', 'fecha', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PROFESOR_ID, self::TITULO, self::URL, self::FECHA, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'profesor_id', 'titulo', 'url', 'fecha', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProfesorId' => 1, 'Titulo' => 2, 'Url' => 3, 'Fecha' => 4, 'Slug' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'profesorId' => 1, 'titulo' => 2, 'url' => 3, 'fecha' => 4, 'slug' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PROFESOR_ID => 1, self::TITULO => 2, self::URL => 3, self::FECHA => 4, self::SLUG => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'profesor_id' => 1, 'titulo' => 2, 'url' => 3, 'fecha' => 4, 'slug' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VideoPeer::PROFESOR_ID);

		$criteria->addSelectColumn(VideoPeer::TITULO);

		$criteria->addSelectColumn(VideoPeer::URL);

		$criteria->addSelectColumn(VideoPeer::FECHA);
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $criteria, $con);
    }
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(VideoPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Video objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $c, $con);
    }
		...
		$c->addJoin(array(VideoPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Video) to $obj2 (sfGuardUser)
				$obj2->addVideo($obj1);
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Video) to the collection in $obj2 (sfGuardUser)
				$obj2->addVideo($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseVideoPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseVideoPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseVideoPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseVideoPeer', $values, $con, $ret);
    }

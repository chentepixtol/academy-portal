...
abstract class BaseProyecto extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProyectoPeer';
	...
	/**
	 * Initializes internal state of BaseProyecto object.
	 * @see        applyDefaults()
	 */
	...
	public function setProfesorId($v)
	{
		...
		if ($this->profesor_id !== $v) {
			$this->profesor_id = $v;
			$this->modifiedColumns[] = ProyectoPeer::PROFESOR_ID;
		}
	...
	public function setTitulo($v)
	{
		...
		if ($this->titulo !== $v) {
			$this->titulo = $v;
			$this->modifiedColumns[] = ProyectoPeer::TITULO;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ProyectoPeer::FECHA;
			}
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = ProyectoPeer::SLUG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ProyectoPeer::NUM_COLUMNS - ProyectoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProyectoPeer::PROFESOR_ID)) $criteria->add(ProyectoPeer::PROFESOR_ID, $this->profesor_id);
		if ($this->isColumnModified(ProyectoPeer::TITULO)) $criteria->add(ProyectoPeer::TITULO, $this->titulo);
		if ($this->isColumnModified(ProyectoPeer::DESCRIPCION)) $criteria->add(ProyectoPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(ProyectoPeer::FECHA)) $criteria->add(ProyectoPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(ProyectoPeer::SLUG)) $criteria->add(ProyectoPeer::SLUG, $this->slug);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->profesor_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addProyectos($this);
			 */
		}

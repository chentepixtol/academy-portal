...
abstract class BaseMateriaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Slug' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'slug' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE => 1, self::SLUG => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'slug' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new MateriaMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MateriaPeer::SLUG);
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseMateriaPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseMateriaPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseMateriaPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseMateriaPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseMateriaPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseMateriaPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseMateriaPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += MateriaPeer::doOnDeleteCascade(new Criteria(MateriaPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Materia) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += MateriaPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in MateriaProfesorPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			MateriaProfesorPeer::clearInstancePool();

			// invalidate objects in WikiPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = MateriaPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related MateriaProfesor objects
			$c = new Criteria(MateriaProfesorPeer::DATABASE_NAME);
			
			$c->add(MateriaProfesorPeer::MATERIA_ID, $obj->getId());
			$affectedRows += MateriaProfesorPeer::doDelete($c, $con);

			// delete related Wiki objects
			$c = new Criteria(WikiPeer::DATABASE_NAME);
			
			$c->add(WikiPeer::MATERIA_ID, $obj->getId());
			$affectedRows += WikiPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
//
// NOTE: This static code cannot call methods on the MateriaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the MateriaPeer class:
//
// Propel::getDatabaseMap(MateriaPeer::DATABASE_NAME)->addTableBuilder(MateriaPeer::TABLE_NAME, MateriaPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseMateriaPeer::DATABASE_NAME)->addTableBuilder(BaseMateriaPeer::TABLE_NAME, BaseMateriaPeer::getMapBuilder());

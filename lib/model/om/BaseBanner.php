  ...
  const PEER = 'BannerPeer';
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = BannerPeer::DESCRIPCION;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BannerPeer::FECHA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = BannerPeer::NUM_COLUMNS - BannerPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BannerPeer::DESCRIPCION)) $criteria->add(BannerPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(BannerPeer::TEXTO)) $criteria->add(BannerPeer::TEXTO, $this->texto);
		if ($this->isColumnModified(BannerPeer::FECHA)) $criteria->add(BannerPeer::FECHA, $this->fecha);

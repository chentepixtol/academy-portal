...
abstract class BaseProyectoPeer {
	...
	const PROFESOR_ID = 'proyecto.PROFESOR_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ProfesorId', 'Titulo', 'Descripcion', 'Fecha', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'profesorId', 'titulo', 'descripcion', 'fecha', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PROFESOR_ID, self::TITULO, self::DESCRIPCION, self::FECHA, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'profesor_id', 'titulo', 'descripcion', 'fecha', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProfesorId' => 1, 'Titulo' => 2, 'Descripcion' => 3, 'Fecha' => 4, 'Slug' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'profesorId' => 1, 'titulo' => 2, 'descripcion' => 3, 'fecha' => 4, 'slug' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PROFESOR_ID => 1, self::TITULO => 2, self::DESCRIPCION => 3, self::FECHA => 4, self::SLUG => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'profesor_id' => 1, 'titulo' => 2, 'descripcion' => 3, 'fecha' => 4, 'slug' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ProyectoMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProyectoPeer::PROFESOR_ID);

		$criteria->addSelectColumn(ProyectoPeer::TITULO);

		$criteria->addSelectColumn(ProyectoPeer::DESCRIPCION);

		$criteria->addSelectColumn(ProyectoPeer::FECHA);

		$criteria->addSelectColumn(ProyectoPeer::SLUG);
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $criteria, $con);
    }
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProyectoPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Proyecto objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $c, $con);
    }
		...
		$c->addJoin(array(ProyectoPeer::PROFESOR_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Proyecto) to $obj2 (sfGuardUser)
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Proyecto) to the collection in $obj2 (sfGuardUser)
				$obj2->addProyecto($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseProyectoPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseProyectoPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseProyectoPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseProyectoPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Proyecto) {
...
//
// NOTE: This static code cannot call methods on the ProyectoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ProyectoPeer class:
//
// Propel::getDatabaseMap(ProyectoPeer::DATABASE_NAME)->addTableBuilder(ProyectoPeer::TABLE_NAME, ProyectoPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseProyectoPeer::DATABASE_NAME)->addTableBuilder(BaseProyectoPeer::TABLE_NAME, BaseProyectoPeer::getMapBuilder());

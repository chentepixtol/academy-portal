  ...
  const PEER = 'VideoPeer';
	...
	public function setProfesorId($v)
	{
		...
		if ($this->profesor_id !== $v) {
			$this->profesor_id = $v;
			$this->modifiedColumns[] = VideoPeer::PROFESOR_ID;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = VideoPeer::FECHA;
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::PROFESOR_ID)) $criteria->add(VideoPeer::PROFESOR_ID, $this->profesor_id);
		...
		if ($this->isColumnModified(VideoPeer::FECHA)) $criteria->add(VideoPeer::FECHA, $this->fecha);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->profesor_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addVideos($this);
			 */
		}

...
class WikiPeer extends BaseWikiPeer
{
  ...
  {
    return sfConfig::get('sf_data_dir').'/wiki.index';
  }
  ...
  /**
   * Obtiene el ultimo objeto que fue modificado 
   * @return Wiki
   */
  public static function getUltimaModificacion()
  {
    $c = new Criteria();
    $c->addDescendingOrderByColumn(self::FECHA);

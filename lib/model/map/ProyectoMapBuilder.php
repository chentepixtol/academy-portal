...
/**
 * This class adds structure of 'proyecto' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class ProyectoMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(ProyectoPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(ProyectoPeer::TABLE_NAME);
		$tMap->setPhpName('Proyecto');
		$tMap->setClassname('Proyecto');
		...
		$tMap->addColumn('TITULO', 'Titulo', 'VARCHAR', true, 100);

...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define("CONFIG_LOGIN_USERNAME", 'user21a');
	define('CONFIG_LOGIN_PASSWORD', 'prof_esime91');
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,fla,swf,zip'); // 
	...
	define('CONFIG_UPLOAD_INVALID_EXTS', 'exe');
